...
namespace Vintagestory.GameContent
{
    ...
    public class BlockEntityShingleForm : BlockEntityDisplayCase, ITexPositionSource
    {
        private readonly int maxSlots = 6;
        public override string InventoryClassName => "shingleform";
        protected InventoryGeneric inventory;

        public override InventoryBase Inventory => this.inventory;


        public BlockEntityShingleForm()
        {
        ...
        internal bool OnInteract(IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            else
            {
                ...
                {
                    if (colObj.Code.Path.StartsWith("clay-"))
                    {
        ...
        {
            MeshData mesh;
            var shapeBase = "brickmold:shapes/";
            var block = this.Api.World.BlockAccessor.GetBlock(this.Pos) as BlockShingleForm;
